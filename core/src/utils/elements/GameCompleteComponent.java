...
//		container.addActor(messageContainer);
...
//				+ 10, btnFacebook.getY());
//
//		messageContainer.setSize(200, 200);
//		messageContainer.setOrigin(Align.center);
//		messageContainer.setPosition(Constants.WIDTH_SCREEN / 2,
...
//				/ 2, Constants.HEIGHT_SCREEN / 2 - messageContainer.getHeight() / 2
...
//		messageContainer.setColor(messageContainer.getColor().r, messageContainer.getColor().g,
//				messageContainer.getColor().b, 0f);
//
//	}
//
...
//		messageContainer.addAction(Actions.alpha(1f, duration));
//
//	}
//
...
//		messageContainer.addAction(Actions.alpha(0f, duration));
//
//	}
//
