...
public class LaserLine {
	...
	public LaserLine(Vector2 startPoint, Vector2 endPoint, Color color,
	...
	public LaserLine(Vector2 startPoint, Vector2 endPoint) {
		super();
		this.startPoint = startPoint;
		this.endPoint = endPoint;
		setup();
	...
	void setup() {
		...
		Texture texLaserM1 = new Texture(
				Gdx.files.internal("Img/beammid1.png"));
		Texture texLaserM2 = new Texture(
				Gdx.files.internal("Img/beammid2.png"));
