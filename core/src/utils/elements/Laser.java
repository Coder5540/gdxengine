...
public class Laser {
	...
	public Laser() {
		Texture texLaserS1 = new Texture(
				Gdx.files.internal("Img/beamstart1.png"));
		Texture texLaserS2 = new Texture(
				Gdx.files.internal("Img/beamstart2.png"));
		Texture texLaserM1 = new Texture(Gdx.files.internal("Img/beammid1.png"));
		Texture texLaserM2 = new Texture(Gdx.files.internal("Img/beammid2.png"));
		Texture texLaserE1 = new Texture(Gdx.files.internal("Img/beamend1.png"));
		Texture texLaserE2 = new Texture(Gdx.files.internal("Img/beamend2.png"));
